...
<?php
    ...
    if(isset($_POST['submit'])){
      ...
      $user = "SELECT username FROM register_db WHERE username='$username'";
      $uresult = mysqli_query($conn, $user);

      $ema = "SELECT email FROM register_db WHERE email='$email'";
    ...
    if(count($errors) == 0){
        ...
        $sql = "INSERT INTO register_db (username, email, password)
